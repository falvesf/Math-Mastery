...
// Nº de acertos para congelar com o efeito de gelo (2 = mais visível/testável;
// antes 4, mas raramente acontecia antes da luta acabar).
export const FREEZE_HITS_TO_FREEZE = 2;
