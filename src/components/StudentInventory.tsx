                ...
                <div key={item.id || index} 
                  ...
                  {viewMode === 'list' ? (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem', flex: 1, minWidth: 0, justifyContent: 'center' }}>
                      <h4 style={{ margin: 0, fontSize: '0.7rem', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }} title={item.itemTitle}>{item.itemType === 'equippable' ? forgeItemName(item.itemTitle, item.forgeLevel || 0) : item.itemTitle}</h4>
