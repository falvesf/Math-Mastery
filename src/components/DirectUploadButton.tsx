...
export default function DirectUploadButton({ onUploadComplete, folder = 'uploads', buttonStyle, accept = 'image/*', maxImageSizeBytes = MAX_IMAGE_SIZE_BYTES, children }: DirectUploadButtonProps) {
