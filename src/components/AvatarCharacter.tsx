...
if (config?.customModelUrl) {
  return <CustomModelViewer modelUrl={config.customModelUrl} textureUrl={config.customSkinUrl} animation={animation as any} size={size} role={role} interactive={interactive} zoom={config.customZoom} configRotY={config.customRotY} shattered={fallenBodyParts && fallenBodyParts.length > 0} />;
}
